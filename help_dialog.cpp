...
void HelpDialog::on_next_button_clicked()
{
    ...
    if(cont == cont_max){
        ...
        ui->warning_label->setText("ADVERTENCIA: En caso de que los índices no sean correlativos y/o el mismo metanodo/parámetro tenga dos índices diferentes, se mostrará un mensaje de error");

        setFixedSize(1150,500);
