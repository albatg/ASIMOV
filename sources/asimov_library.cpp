...
TModelParameter::TModelParameter(QString m_ID, QString m_Description, double m_Value,double m_Precision, bool m_Tag)
    : m_id(m_ID), m_description(m_Description), m_value(m_Value), m_precision(m_Precision), m_tag(m_Tag)
{}
